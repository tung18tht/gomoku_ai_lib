...
class Game(object):
    ...
    def graphic(self):
        ...
        print("Player", self.players[1].player, "with X".rjust(3))
        print("Player", self.players[2].player, "with O".rjust(3))
        ...
        for i in range(height - 1, -1, -1):
            ...
            for j in range(width):
                ...
                if p == self.players[1].player:
                    print('X'.center(4), end='')
                elif p == self.players[2].player:
